...
class ShipmentRateRequest
{
     ...
     * @param  list<array{package_code?: string, weight: array{value: float|int, unit: string}, dimensions?: array{unit: string, length: float|int, width: float|int, height: float|int}}>  $packages
